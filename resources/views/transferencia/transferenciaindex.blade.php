                                ...
                                <form method="POST" action="{{ route('transferencia.store') }}" class="form-horizontal">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 qr-container">
                                            ...
                                            <img src="{{ route('qrcode.generate', ['address' => $destinoAddress]) }}"
                                                alt="QR Code">
                                            <div class="input-group mt-3">
                                                <input type="text" id="destinoAddress" name="from_address"
                                                    class="form-control" value="{{ $destinoAddress }}" readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input name="to_address" id="to_address" class="form-control" type="text"
                                                required>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <button type="submit" id="transferButton" class="btn btn-primary"
                                                disabled>Transferir</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
