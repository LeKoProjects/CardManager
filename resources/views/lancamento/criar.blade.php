            ...
            <div class="card shadow mb-7">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-warning" id="reserveButton" style="display: none;">Reservar</button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="tile">
                                                        ...
                                                        <form method="POST" action="{{ route('lancamento.update', $item->id) }}" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                <div class="mb-3 col-md-12">
                                                                    ...
                                                                    <input name="codigo" id="codigo{{ $item->id }}" class="form-control" type="text"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-4">
                                                                    ...
                                                                    <input name="valor" id="valor{{ $item->id }}" class="form-control valor" type="text"
